<?php
    ...
    if (isset($status) && $status === "success") {
        ...
        isset($_POST['coordinatorContact2'])) {
            $query = "INSERT INTO events (title, description, rules, judging_criteria, date, venue, time, category, coordinatorName1, coordinatorContact1, coordinatorName2, coordinatorContact2,date1,time1,loginId,loginPassword) VALUES ('".mysqli_real_escape_string($conn,$_POST['title'])."','".mysqli_real_escape_string($conn,$_POST['description'])."','".mysqli_real_escape_string($conn,$_POST['rules'])."','".mysqli_real_escape_string($conn,$_POST['judging_criteria'])."','".mysqli_real_escape_string($conn,$_POST['date'])."','".mysqli_real_escape_string($conn,$_POST['venue'])."','".mysqli_real_escape_string($conn,$_POST['time'])."','".mysqli_real_escape_string($conn,$_POST['category'])."','".mysqli_real_escape_string($conn,$_POST['coordinatorName1'])."','".mysqli_real_escape_string($conn,$_POST['coordinatorContact1'])."','".mysqli_real_escape_string($conn,$_POST['coordinatorName2'])."','".mysqli_real_escape_string($conn,$_POST['coordinatorContact2'])."','".mysqli_real_escape_string($conn,$_POST['date1'])."','".mysqli_real_escape_string($conn,$_POST['time1'])."','".mysqli_real_escape_string($conn,$_POST['loginId'])."','".mysqli_real_escape_string($conn,$_POST['loginPassword'])."')";
