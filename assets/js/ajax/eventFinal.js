		...
		success: function (data) {
			...
			if (dataArray["status"] == "success") {
				...
				for (var i = 0; i < eventArray.length; i++) {
                	...
                	else if (eventArray[i]["category"] == "guest") {
						event_guest.push(eventArray[i]);
					}
            	...
            	// Guest lecture
				if (event_guest.length == 0) {
					var str = "<p>No events to display.</p>";
					// $("#funevents").children("center").append(str);
						$('#guest_lec').html(str);
				} else {
					if ((event_guest.length) % 3 == 0) {
						var index = 0;
						var str='';
						while (index < (event_guest.length) / 3) {
							str = str + '<div class="row">';
							str = str + '<div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index]["eid"] +'" value="' + event_guest[3 * index]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index]["image_path"]+ '" alt=" Event ' + event_guest[3 * index]["eid"] + '" class="img-fluid"></div></a></div><div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index + 1]["eid"] +'" value="' + event_guest[3 * index + 1]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index + 1]["image_path"] + '" alt=" Event ' + event_guest[3 * index + 1]["eid"] + '" class="img-fluid"></div></a></div><div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index + 2]["eid"] +'" value="' + event_guest[3 * index + 2]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index + 2]["image_path"] + '" alt=" Event ' + event_guest[3 * index + 2]["eid"] + '" class="img-fluid"></div></a></div>';	
							str = str + '</div>'

							$("#guest_lec").children("center").append(str);							 
							index = index + 1;
						}
						$('#guest_lec').html(str);
						...
						var index = 0;
						var str="";
						while (index < (event_guest.length - (event_guest.length) % 3) / 3) {
							str = str + '<div class="row">';
							str = str + '<div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index]["eid"] +'" value="' + event_guest[3 * index]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index]["image_path"]+ '" alt=" Event ' + event_guest[3 * index]["eid"] + '" class="img-fluid"></div></a></div><div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index + 1]["eid"] +'" value="' + event_guest[3 * index + 1]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index + 1]["image_path"] + '" alt=" Event ' + event_guest[3 * index + 1]["eid"] + '" class="img-fluid"></div></a></div><div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index + 2]["eid"] +'" value="' + event_guest[3 * index + 2]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index + 2]["image_path"] + '" alt=" Event ' + event_guest[3 * index + 2]["eid"] + '" class="img-fluid"></div></a></div>';	
							str = str + '</div>'			
							index = index + 1;
						...
						if ((event_guest.length) % 3 == 1) {
							str = str + '<div class="row">';
							str = str + '<div class="col-lg-4 col-md-6 offset-md-4"><a href="../views/event-details.html?eid='+ event_guest[3 * index]["eid"] +'" value="' + event_guest[3 * index]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index]["image_path"]+ '" alt=" Event ' + event_guest[3 * index]["eid"] + '" class="img-fluid"></div></a></div>';	
							str = str + '</div>'

						} else if ((event_guest.length) % 3 == 2) {
							str = str + '<div class="row">';
							str = str + '<div class="col-lg-4 col-md-6 offset-md-2"><a href="../views/event-details.html?eid='+ event_guest[3 * index]["eid"] +'" value="' + event_guest[3 * index]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index]["image_path"]+ '" alt=" Event ' + event_guest[3 * index]["eid"] + '" class="img-fluid"></div></a></div><div class="col-lg-4 col-md-6"><a href="../views/event-details.html?eid='+ event_guest[3 * index + 1]["eid"] +'" value="' + event_guest[3 * index + 1]["eid"] + '"><div class="speaker"><img src="../' + event_guest[3 * index + 1]["image_path"] + '" alt=" Event ' + event_guest[3 * index + 1]["eid"] + '" class="img-fluid"></div></a></div>';	
							str = str + '</div>'
